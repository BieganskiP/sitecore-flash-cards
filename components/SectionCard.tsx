...
export default function SectionCard({ section }: SectionCardProps) {
  ...
  return (
    <Link
      ...
      className="group block bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 hover:border-blue-500 transition-all hover:shadow-xl hover:shadow-blue-500/10"
    >
      {/* Header */}
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          <Clock className="w-4 h-4 text-zinc-600 dark:text-zinc-400" aria-hidden="true" />
      ...
      {/* Stats */}
      <div className="flex items-center gap-4 text-xs text-zinc-600 dark:text-zinc-300 pt-4 border-t border-zinc-200 dark:border-zinc-800">
        ...
        <ChevronRight className="w-4 h-4 ml-auto text-zinc-500 dark:text-zinc-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" aria-hidden="true" />
      </div>
    </Link>
  );
}
