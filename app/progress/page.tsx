...
export default function ProgressPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 pt-20 lg:pt-8">
      ...
      {/* Section Progress */}
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 sm:p-6 mb-6 lg:mb-8">
          ...
          {sections.map((section) => {
            ...
            return (
              <Link
                ...
                className="block p-4 sm:p-5 rounded-lg border border-zinc-800 hover:border-blue-500 hover:bg-zinc-800/50 transition-all group"
              >
                ...
                <div className="w-full bg-zinc-800 rounded-full h-1.5 sm:h-2 mb-2 sm:mb-3 overflow-hidden">
                  <div
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-4 text-[10px] sm:text-xs">
                    <span className="flex items-center gap-1 sm:gap-1.5">
                      {sectionProgress.flashExposureCompleted ? (
                        ...
                        <Circle className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-zinc-600" />
                      )}
                      <span
                        className={
                          sectionProgress.flashExposureCompleted
      ...
      {/* Reset Progress */}
      <div className="bg-zinc-900 border border-red-900/50 rounded-xl p-4 sm:p-6">
            ...
            {!showResetConfirm ? (
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-zinc-800 text-zinc-300 rounded-lg hover:bg-zinc-700 transition-colors text-xs sm:text-sm font-medium"
                >
                  Cancel
                </button>
              </div>
