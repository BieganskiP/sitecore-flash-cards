    ...
    <div className="p-4 sm:p-6 lg:p-8 pt-20 lg:pt-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 lg:mb-8">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 rounded-xl p-4 sm:p-6 hover:border-zinc-400 dark:hover:border-zinc-700 transition-colors"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 lg:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {learningPhases.map((phase, index) => {
                ...
                return (
                  <div
                    key={phase.id}
                    className="bg-zinc-200 dark:bg-zinc-800 rounded-lg p-3 sm:p-4 hover:bg-zinc-300 dark:hover:bg-zinc-750 transition-colors border border-zinc-300 dark:border-zinc-700"
                  >
                    <div className="flex items-start gap-2 sm:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] sm:text-xs text-zinc-600 dark:text-zinc-300 line-clamp-2">
                          {phase.description}
                        </p>
                      </div>
                    </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="bg-linear-to-br from-blue-600 to-purple-600 rounded-xl p-4 sm:p-6 text-white">
            ...
            <p className="text-xs sm:text-sm text-blue-50 mb-3 sm:mb-4">
          ...
          {[
            ...
            <div key={index} className="flex items-start gap-2 sm:gap-3">
              ...
              <div>
                ...
                <div className="text-[10px] sm:text-xs text-zinc-600 dark:text-zinc-300">
                  {item.desc}
                </div>
              </div>
            </div>
