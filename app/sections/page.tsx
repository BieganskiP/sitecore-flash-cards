  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 pt-20 lg:pt-8">
      ...
      <div className="mb-6 lg:mb-8">
        ...
        <div className="bg-linear-to-r from-blue-950 via-purple-950 to-blue-950 border-2 border-blue-800/50 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 shadow-lg shadow-blue-900/20">
          <div className="flex flex-col gap-4">
            {/* Course Title Row */}
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center shrink-0 shadow-lg">
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between gap-3 mb-2">
                  ...
                  <span className="px-3 py-1.5 bg-linear-to-r from-blue-600 to-purple-600 text-white text-xs rounded-full uppercase font-bold tracking-wider shadow-md">
                    {currentCourse.level}
                  </span>
                </div>
